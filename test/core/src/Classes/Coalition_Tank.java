...
public class Coalition_Tank extends Tank {
    private int maxPowerLaunch;
    private boolean isSurpriseBoxActive;



    public Coalition_Tank(World world, int x, int y, int width, int height, String tankType) {
    ...
    public Coalition_Tank(World world, int x, int y, int width, int height, String tankType, int health, int fuel) {
        super(world, x, y, width, height, tankType);
        this.health = health;
        this.fuel = fuel;
